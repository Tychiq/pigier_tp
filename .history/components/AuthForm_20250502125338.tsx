...
// Form validation schema depending on form type
const authFormSchema = (formType: FormType) =>
  z.object({
    ...
    fullName: formType === "sign-up"
      ...
      : z.string().optional(),
    isStudent: z.boolean().default(false), // Include this field for both sign-up and sign-in
  });
...
const AuthForm = ({ type }: { type: FormType }) => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      // If sign-up or sign-in is successful, store the returned data
      setAccountId(user.accountId);
      setIsStudent(user.isStudent ?? false); // Ensure isStudent is a boolean
    } catch {
  ...
  return (
    <>
      ...
      {/* Show OTP modal after successful user creation or sign-in */}
      {accountId && (
        <OtpModal
