  ...
  return (
    <>
      ...
      <div className="space-y-4 px-2 pt-2">
        ...
        <DetailRow label="Propriétire:" value={file.owner.fullName} />
        <DetailRow label="Dernière modification:" value={formatDateTime(file.$updatedAt)} />
      </div>
    </>
  );
};
  ...
  return (
    <>
      ...
      <div className="share-wrapper">
        ...
        <Input
          type="email"
          placeholder="Entrez les adresses emails"
