...
// ✅ MODIFIED: Add isStudent support to createAccount
  ...
  if (!existingUser) {
    ...
    await databases.createDocument(
      ...
      ID.unique(),
      {
        ...
        accountId,
        isStudent, // ✅ store the student flag
      },
    );
  }
...
// ✅ MODIFIED: signInUser returns isStudent flag for redirection
  ...
  try {
    ...
    if (existingUser) {
      ...
      return parseStringify({
        ...
        isStudent: existingUser.isStudent ?? false,
      });
    }
